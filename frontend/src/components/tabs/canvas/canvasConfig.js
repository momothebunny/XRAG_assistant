...
export const NODE_LIBRARY = [
  ...
  },
  {
    ...
    config: {
      ...
      fallbackMode: 'flag',
      rejectionMessage: 'I cannot answer this based on the available evidence.',
      alwaysPassIfNoEvidence: true,
      appendScore: false,
    },
  },
  {
...
export const RAG_BLUEPRINTS = [
  ...
  {
    id: 'naive-rag-pinecone',
    label: 'Naive RAG - Pinecone Preset',
    description: 'Ready-to-run Naive RAG with Pinecone defaults (cloud index, MMR-ready retriever wiring).',
    backendFlowId: 'flow-naive-rag-pinecone-001',
    templateKeys: [
      'user-actor',
      'input-question',
      'input-upload',
  ...
  {
    id: 'naive-rag-qdrant',
    label: 'Naive RAG - Qdrant Preset',
    description: 'Naive RAG tuned for Qdrant collection + URL configuration with hybrid-ready retrieval metadata.',
    backendFlowId: 'flow-naive-rag-qdrant-001',
    templateKeys: [
      'user-actor',
      'input-question',
      'input-upload',
  ...
  {
    id: 'naive-rag-weaviate',
    label: 'Naive RAG - Weaviate Preset',
    description: 'Naive RAG with Weaviate class/collection defaults and retriever provider metadata preconfigured.',
    backendFlowId: 'flow-naive-rag-weaviate-001',
    templateKeys: [
      'user-actor',
      'input-question',
      'input-upload',
  ...
  {
    id: 'naive-rag-chroma',
    label: 'Naive RAG - Chroma Preset',
    description: 'Naive RAG with Chroma local/server collection defaults for quick local deployment.',
    backendFlowId: 'flow-naive-rag-chroma-001',
    templateKeys: [
      'user-actor',
      'input-question',
      'input-upload',
  ...
  {
    id: 'naive-rag-supabase',
    label: 'Naive RAG - Supabase Preset',
    description: 'Naive RAG with Supabase pgvector defaults (schema + collection) and retriever wiring in place.',
    backendFlowId: 'flow-naive-rag-supabase-001',
    templateKeys: [
      'user-actor',
      'input-question',
      'input-upload',
  ...
  {
    id: 'safety-rag',
    label: 'Safety-First RAG Preset',
    description: 'Retriever output is sanitized by PII redaction, guarded by policy checks, then validated with hallucination scoring.',
    backendFlowId: 'flow-safety-rag-001',
    templateKeys: [
      'user-actor',
      'input-question',
      'input-upload',
