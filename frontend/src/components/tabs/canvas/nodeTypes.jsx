...
export const PALETTES = {
  ...
  violet:  { accent: '#a78bfa', accent2: '#8b5cf6', glow: 'rgba(167,139,250,0.60)', ring: 'rgba(167,139,250,0.45)' },
  fuchsia: { accent: '#e879f9', accent2: '#d946ef', glow: 'rgba(232,121,249,0.55)', ring: 'rgba(232,121,249,0.45)' },
